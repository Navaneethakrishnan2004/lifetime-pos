      ...
      <SidebarHeader className="border-b p-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs font-semibold text-sidebar-foreground/90">Modern POS</p>
          </div>
        </div>
      </SidebarHeader>
                ...
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton asChild>
                    <NavLink
                      ...
                      className="flex items-center gap-3 rounded-lg px-3 py-2 text-sidebar-foreground font-semibold transition-all hover:bg-sidebar-accent"
